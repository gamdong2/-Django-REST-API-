...
## 프로젝트를 통해 얻은 역량
- **Django 웹 개발**: Django 모델링, 뷰, URL 매핑, 템플릿 엔진 활용
- **REST API 설계**: RESTful 엔드포인트 구현
- **웹 크롤링/파싱**: BeautifulSoup, Requests 등을 통해 웹 페이지의 데이터 크롤링
- **데이터베이스 관리**: MySQL 데이터베이스 설정, 쿼리 작성, 데이터 관리
- **UI 및 UX 개선**: 기본 CSS 스타일링을 통한 사용자 경험 향상
